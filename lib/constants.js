...
TRAINING_EFFECT_MULTIPLIER = 0.92;       // 训练效果增幅（训练后属性增加）
OUTFIT_EFFECT_MULTIPLIER = 0.95;         // 集训效果增幅（集训后属性增加）
PRESSURE_INCREASE_MULTIPLIER = 1.15;     // 压力增加量增幅
PASS_LINE_MULTIPLIER = 1.08;             // 分数线增幅
DIFFICULTY_MULTIPLIER = 1.06;            // 题目难度增幅
COST_MULTIPLIER = 1.10;                  // 经费消耗增幅
